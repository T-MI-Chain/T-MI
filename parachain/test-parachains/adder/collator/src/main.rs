...
use tmi_node_subsystem::messages::{CollationGenerationMessage, CollatorProtocolMessage};
use tmi_primitives::v1::Id as ParaId;
use tmi_cli::{Error, Result};
			...
			runner.run_node_until_exit(|config| async move {
				...
				match role {
					...
					_ => {
						...
						let full_node = tmi_service::build_full(
							config,
							tmi_service::IsCollator::Yes(collator.collator_id()),
							None,
							None,
