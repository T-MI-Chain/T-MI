...
/// extensive communication with tmi host, therefore there should be no observable performance penalty
...
impl Default for ExecutorCache {
	fn default() -> Self {
		ExecutorCache(sc_executor::WasmExecutor::new(
			...
			// TODO: Make sure we don't use more than 1GB: https://github.com/tmi/tmi/issues/699
			Some(1024),
...
pub fn validate_candidate_internal(
	...
	let code_hash = {
		use tmi_core_primitives::{BlakeTwo256, HashT};
