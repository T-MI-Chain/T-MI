...
use tmi_node_jaeger::JaegerSpan;
...
mod tests {
	...
	use tmi_primitives::v1::Hash;
	use tmi_node_subsystem_test_helpers::{self as test_helpers, make_subsystem_context};
