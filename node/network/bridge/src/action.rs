...
use tmi_primitives::v1::{AuthorityDiscoveryId, BlockNumber};
use tmi_subsystem::messages::{AllMessages, NetworkBridgeMessage};
use tmi_subsystem::{ActiveLeavesUpdate, FromOverseer, OverseerSignal};
use sc_network::Event as NetworkEvent;

use tmi_node_network_protocol::{request_response::Requests, ObservedRole};
...
pub(crate) enum AbortReason {
	...
	SubsystemError(tmi_subsystem::SubsystemError),
...
impl From<tmi_subsystem::SubsystemResult<FromOverseer<NetworkBridgeMessage>>> for Action {
	fn from(
		res: tmi_subsystem::SubsystemResult<FromOverseer<NetworkBridgeMessage>>,
	) -> Self {
		match res {
