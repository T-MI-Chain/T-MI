...
use tmi_node_network_protocol::PeerId;
use tmi_primitives::v1::{AuthorityDiscoveryId, Block, Hash};
use tmi_node_network_protocol::peer_set::PeerSet;
	...
	pub async fn on_request(
		...
		for authority in validator_ids.iter() {
			...
			if let Some(addresses) = result {
				...
				// https://github.com/tmi/substrate/issues/6845
