...
use tmi_primitives::v1::{ValidatorId, AccountId, AssignmentId};
use tmi_service::chain_spec::{get_account_id_from_seed, get_from_seed, Extensions};
use tmi_test_runtime::constants::currency::DOTS;
...
/// The `ChainSpec` parametrized for tmi test runtime.
pub type tmiChainSpec =
	service::GenericChainSpec<tmi_test_runtime::GenesisConfig, Extensions>;

/// Local testnet config (multivalidator Alice + Bob)
pub fn tmi_local_testnet_config() -> tmiChainSpec {
	tmiChainSpec::from_genesis(
		"Local Testnet",
		"local_testnet",
		ChainType::Local,
		|| tmi_local_testnet_genesis(),
		vec![],
		None,
...
pub fn tmi_local_testnet_genesis() -> tmi_test_runtime::GenesisConfig {
	tmi_testnet_genesis(
		vec![
...
) -> tmi_test_runtime::GenesisConfig {
	use tmi_test_runtime as runtime;
