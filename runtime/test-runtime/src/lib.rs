...
//! The tmi runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
use tmi_runtime_parachains::configuration as parachains_configuration;
use tmi_runtime_parachains::inclusion as parachains_inclusion;
use tmi_runtime_parachains::inclusion_inherent as parachains_inclusion_inherent;
use tmi_runtime_parachains::initializer as parachains_initializer;
use tmi_runtime_parachains::session_info as parachains_session_info;
use tmi_runtime_parachains::paras as parachains_paras;
use tmi_runtime_parachains::dmp as parachains_dmp;
use tmi_runtime_parachains::ump as parachains_ump;
use tmi_runtime_parachains::hrmp as parachains_hrmp;
use tmi_runtime_parachains::scheduler as parachains_scheduler;
use tmi_runtime_parachains::runtime_api_impl::v1 as runtime_impl;
...
use tmi_runtime_parachains::reward_points::RewardValidatorsWithEraPoints;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("tmi-test-runtime"),
	impl_name: create_runtime_str!("parity-tmi-test-runtime"),
	authoring_version: 2,
	spec_version: 1055,
	impl_version: 0,
...
sp_api::impl_runtime_apis! {
	...
	impl babe_primitives::BabeApi<Block> for Runtime {
		fn configuration() -> babe_primitives::BabeGenesisConfiguration {
			...
			// <https://research.web3.foundation/en/latest/tmi/BABE/Babe/#6-practical-results>
