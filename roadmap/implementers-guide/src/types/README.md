...
These data types are defined in `tmi/primitives/src/v1.rs`:
...
digraph {
    ...
    Id [label="tmi_parachain::primitives::Id"]
    CollatorId [label="tmi_primitives::v0::CollatorId"]
    ...
    TransientValidationData:balance -> "tmi_core_primitives::v1::Balance":w
    ...
    CandidateCommitments:upward_messages -> "tmi_parachain::primitives::UpwardMessage":w
    CandidateCommitments:horizontal_messages -> "tmi_core_primitives::v1::OutboundHrmpMessage":w
    CandidateCommitments:head_data -> HeadData:w
    CandidateCommitments:horizontal_messages -> "tmi_parachain::primitives::Id":w
    CandidateCommitments:new_validation_code -> "tmi_parachain::primitives::ValidationCode":w
    ...
    PoV:block_data -> "tmi_parachain::primitives::BlockData":w
    ...
    BackedCandidate:validity_votes  -> "tmi_primitives:v0:ValidityAttestation":w

    HeadData [label = "tmi_parachain::primitives::HeadData"]
    ...
    ValidatorId [label = "tmi_primitives::v0::ValidatorId"]
    AuthorityDiscoveryId [label = "sp_authority_discovery::AuthorityId"]
    ValidatorIndex [label = "tmi_primitives::v0::ValidatorIndex"]
...
These data types are defined in `tmi/parachain/src/primitives.rs`:
...
digraph {
    ...
    RelayChainBlockNumber [label = "tmi_core_primitives::BlockNumber"]
    ...
    OutboundHrmpMessage [label = "tmi_core_primitives::OutboundHrmpMessage"]
}
```
